...
var BigInt = require('@tradle/otr/vendor/bigint')
var bits2bigInt = require('@tradle/otr/lib/helpers').bits2bigInt
...
DSAKey.prototype._signSync = function (msg) {
  var sig = this.priv().sign(msg)
  return toString(sig)
}

DSAKey.prototype._verifySync = function (msg, sig) {
  sig = parseSig(sig)
